...
int physicalMemory[256 * 128]; //For part 2, the size of the physical memory is 128 frames, not 256
...
int getDataFromBackingStore(int pageNumber) {
	...
	for (int i = 0; i < 256; i++)
	{
		physicalMemory[(frame * 256) + i] = (int)storage[i]; //store the page in a free frame
	}
